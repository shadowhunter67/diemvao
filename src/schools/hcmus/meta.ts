...
/**
 * Metadata NHẸ — KHÔNG import `HcmusPage` (xem `hcmut/meta.ts` cho rationale đầy đủ về tách
 * meta/Page phục vụ code splitting). `index.ts` compose `{ ...hcmusMeta, Page: HcmusPage }`.
 *
 * HCMUS 2026: supports real partial academic-score calculation and the official 39-program
 * registration threshold table. Final exact score remains blocked by unresolved bonus and
 * priority rules.
 */
export const hcmusMeta: Omit<SchoolModule, 'Page'> = {
  id: 'hcmus',
