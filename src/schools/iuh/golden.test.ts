...
describe('IUH 2026 golden conformance — xét tuyển kết hợp (Tier C — sourceId iuh-formula-2026/iuh-quality-threshold-2026/iuh-bonus-appendix-2026)', () => {
  ...
  it.each(iuhCombinedGoldenCases)('$id', (goldenCase) => {
    ...
    // Không có ĐGNL trong fixture này → ĐK = Max(ĐTN, ĐĐGNL) = ĐTN (ĐĐGNL vắng mặt).
    const xt1 = calculateIuhXt1({ academicScore30: thptTotal30, transcriptTotal30, priority30: priority.effectivePriority30, bonus30 });
