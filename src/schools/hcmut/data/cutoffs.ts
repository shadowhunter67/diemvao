...
export const hcmutCutoffs: AdmissionCutoff[] = [
  ...
  { year: 2025, programId: 'ky-thuat-co-dien-tu', score: 81.82, method: 'combined', ...SOURCE_2025_TUYENSINH247 },
  { year: 2025, programId: 'quan-ly-cong-nghiep', score: 75.98, method: 'combined', ...SOURCE_2025_TUYENSINH247 },
  {
    year: 2025,
    programId: 'logistics-he-thong-cong-nghiep',
    score: 80.52,
  ...
  { year: 2025, programId: 'vat-ly-ky-thuat', score: 76.61, method: 'combined', ...SOURCE_2025_TUYENSINH247 },
  {
    year: 2025,
    programId: 'song-nganh-tau-thuy-hang-khong',
    score: 76.63,
  ...
  {
    year: 2025,
    programId: 'dia-ky-thuat-xay-dung',
    score: 55.06,
    method: 'combined',
    ...SOURCE_2025_TUYENSINH247,
  },
  { year: 2025, programId: 'kinh-te-xay-dung', score: 55.72, method: 'combined', ...SOURCE_2025_TUYENSINH247 },

  // ===== 2025 — Chương trình tiếng Anh =====
  { year: 2025, programId: 'thiet-ke-vi-mach-ta', score: 83.09, method: 'combined', ...SOURCE_2025_TUYENSINH247 },
  {
    year: 2025,
    programId: 'khoa-hoc-may-tinh-ta',
    score: 83.74,
    method: 'combined',
    ...SOURCE_2025_TUYENSINH247,
  },
  {
    year: 2025,
    programId: 'ky-thuat-co-dien-tu-ta',
    score: 78.44,
    method: 'combined',
    ...SOURCE_2025_TUYENSINH247,
  },
  {
    year: 2025,
    programId: 'ky-thuat-may-tinh-ta',
    score: 78.66,
    method: 'combined',
    ...SOURCE_2025_TUYENSINH247,
  },
  { year: 2025, programId: 'ky-thuat-dau-khi-ta', score: 60.25, method: 'combined', ...SOURCE_2025_TUYENSINH247 },

  // ===== 2025 — Chương trình tiên tiến / chuyển tiếp quốc tế =====
  {
    year: 2025,
    programId: 'ky-thuat-dien-dien-tu-tien-tien',
    score: 79.5,
  ...
  },
  {
    ...
    score: 72.9,
    method: 'combined',
    note: 'Chương trình chuyển tiếp quốc tế (Úc/New Zealand/Mỹ), tiêu chí xét tuyển có thể khác chuẩn 3 thành phần của phương thức Tổng hợp thường.',
    ...SOURCE_2025_TUYENSINH247,
  },
];
