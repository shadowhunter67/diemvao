...
UniScoreVN accepts reports about incorrect, incomplete, or stale admission data through GitHub issues.

Please include:

- the school and admission year;
- the method or program affected;
- the official source URL;
- the exact value or rule that appears wrong;
- screenshots only when the official source is difficult to navigate.
