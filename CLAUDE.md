...
**Product identity**: UniscoreVN là nền tảng multi-school (kiến trúc). Nguồn sự thật cho "trường nào exact" là `AdmissionMethodDescriptor.capabilities.exactCalculator` (`schools/<id>/methods.ts`), KHÔNG phải mô tả tiếng Việt ở đây — kiểm chứng lại nếu nghi ngờ đoạn này lỗi thời, xem `docs/architecture.md` mục golden/domain conformance trước khi tin, hoặc README.md mục "Trường đang hỗ trợ" cho danh sách đầy đủ hiện tại. Tính đến batch FTU/PTIT/NEU (2026-08-21): **HCMUT/UEH/UEL/HCMUS/USSH/IU/TDTU/HUFLIT/HUTECH/UFM/IUH/HCMULAW/UMP/FTU** có exact calculator ở ít nhất 1 phương thức — USSH/IU/TDTU/HUFLIT/HUTECH chỉ exact trong phạm vi thí sinh KHÔNG có thành tích cộng điểm (HUTECH thêm: chỉ 2/4 phương thức, xem `schools/hutech/knowledgeGaps.ts`). **UFM** exact CẢ 4/4 phương thức (thi TN THPT/học bạ/ĐGNL/V-SAT, chương trình Chuẩn — batch 2026-08-20, xem `schools/ufm/conversionTable.ts`) và ĐÃ hỗ trợ thí sinh CÓ thành tích cộng điểm. Học bạ/ĐGNL/V-SAT quy đổi qua bảng bách phân vị chính thức (Thông báo 2639/TB-ĐHTCM mục 3) sang thang 30 trước khi cộng ưu tiên/điểm cộng — verified khớp ví dụ minh họa chính thức của văn bản. Hệ số Toán×2 (chương trình Tiếng Anh toàn phần) ngoài phạm vi, xem `schools/ufm/knowledgeGaps.ts`. **IUH** exact "xét tuyển kết hợp" (Trụ sở chính TP.HCM, chương trình Chuẩn) cả 3 nhánh XT1/XT2/XT3 — batch 2026-08-20 xác định ĐTK 2026=1139 (verified qua ĐHQG-HCM + cross-check độc lập UFM, xem `schools/iuh/calculator.ts:IUH_DTK_2026`). **HCMULAW** exact 2/4 phương thức (Phương thức 5 thi TN THPT + Phương thức 4 V-SAT, quy đổi RIÊNG TỪNG MÔN qua bảng bách phân vị 7 môn — batch 2026-08-20, `schools/hcmulaw/conversionTable.ts`) — Phương thức 2/3 (dựa học bạ) vẫn `unavailable`, công thức y=x-k đã công bố nhưng cần TB học bạ theo 6 học kỳ (hồ sơ dùng chung chỉ lưu TB năm), xem `schools/hcmulaw/knowledgeGaps.ts`. **UIT** có trang thông tin + eligibility/bonus checker + điểm chuẩn thật, chưa có calculator chính xác (`status: 'researching'`, thiếu bảng bách phân vị). **AGU/UHS/HCMUE/HCMUTE/VLU/PTIT/NEU/HUB/HUIT/NTTU/HSU/UEF/CTU/TDMU/HIU/OU/SGU/HNUE/VinhUni/UTC** có eligibility/threshold checker thật, chưa đủ nguồn cho exact calculator. Mỗi trường có công thức/input schema/thang điểm hoàn toàn khác — KHÔNG ép mọi trường dùng chung một "universal formula engine". Xem README.md mục "Kiến trúc multi-school" + "HCMUT module".
